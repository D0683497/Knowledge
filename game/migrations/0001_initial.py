# Generated by Django 2.2.8 on 2019-12-12 20:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('select_option', models.CharField(blank=True, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ManyToManyField(to='game.Round')),
            ],
        ),
        migrations.CreateModel(
            name='ExtendUser',
            fields=[
                ...
                ('history', models.ManyToManyField(to='game.History')),
